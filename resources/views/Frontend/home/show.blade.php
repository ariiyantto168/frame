                           ...
                           <div class="product-toys-info">
                              <div class="men-pro-item">
                                 <div class="men-thumb-item">
                                    <img src="@if(!is_null($product->images)){{asset('porducts_images')}}/{{$product->images->name }}@endif" class="img-thumbnail img-fluid" alt="">
                                    <div class="men-cart-pro">
                                       <div class="inner-men-cart-pro">
                                          <a href="{{url('home/detail/'. $product->slug)}}" class="link-product-add-cart">Quick View</a>
                                       </div>
                                    </div>
                                    ...
                                    <div class="info-product-price">
                                       <div class="grid_meta">
                                          <div class="product_price">
                                             ...
                                             <span class="money ">{{$product->type}}</span>
                                             </div>
                                          </div>
                                          <ul class="stars">
                                             <li>
                                                <a href="#">
                                                <i class="money">{{$product->size}}</i>
                                                </a>
                                             </li>
                                          </ul>
                                       </div>
