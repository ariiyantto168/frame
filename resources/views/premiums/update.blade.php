...
<section>
    ...
    <section class="content">
            ...
            <div class="box">
              ...
              <div class="box-body">
                {{ Form::open(array('url' => 'premiums/update/'.$premiums->idpremiums, 'class' => 'form-horizontal')) }}
                
                <div class="form-group">
                  <label class="col-sm-2 control-label">Name</label>
                  <div class="col-sm-5">
                    <!-- {{-- name:name untuk melempar controller ke database --}} -->
                  <input type="text" class="form-control" value="{{$premiums->name}}" name="name" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <textarea name="description" rows="3" id="description" class="form-control" required>{{$premiums->description}}</textarea>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <a href="{{url('premiums')}}" class="btn btn-warning pull-right">Back</a>
