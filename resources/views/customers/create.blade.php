<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('/customers')}}"><i class="fa fa-cubes"></i>Customers</a>
...
<section>
    ...
    <section class="content">
            ...
            <div class="box">
              ...
              <div class="box-body">
                {{ Form::open(array('url' => 'customers/create-new', 'class' => 'form-horizontal')) }}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <a href="{{url('customers')}}" class="btn btn-warning pull-right">Back</a>
